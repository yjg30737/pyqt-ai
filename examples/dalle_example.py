...
from qtpy.QtWidgets import QLineEdit, QVBoxLayout, QWidget, QMainWindow, QPushButton, QApplication, QGroupBox, \
        QPlainTextEdit, QFormLayout, QSplitter, QComboBox, QSizePolicy
...
class MainWindow(QMainWindow):
    ...
    def __initUi(self):
        ...
        self.__heightComboBox.addItems([
            '256', '512', '1024', '1792'
        ])
